...
define config.name = _("Camping au Summer Paradise")
...
define build.name = "CampingauSummerParadise"
...
define config.main_menu_music = "ost/around_the_fire.mp3"
...
define config.save_directory = "CampingauSummerParadise-1786302880"
